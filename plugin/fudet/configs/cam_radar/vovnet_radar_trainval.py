...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='data/' + 'nusc_new/nuscenes_5sweeps_infos_trainval_radar.pkl',
    ...
    val=dict(
        ...
        classes=class_names, 
        modality=input_modality, 
        ann_file='data/nusc_new/' + 'nuscenes_5sweeps_infos_test_radar.pkl'),
    test=dict(
        type=dataset_type,
        pipeline=test_pipeline, 
        classes=class_names, 
...
load_from='checkpoint/detr3d_vovnet_trainval.pth'
