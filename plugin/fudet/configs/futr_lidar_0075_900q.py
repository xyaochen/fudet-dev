...
data = dict(
    train=dict(
        ...
        dataset=dict(
            ...
            box_type_3d='LiDAR')),
    val=dict(pipeline=test_pipeline, classes=class_names, ann_file='data/' + 'nuscenes_5sweeps_infos_val_radar.pkl'),
    test=dict(pipeline=test_pipeline, classes=class_names, ann_file='data/' + 'nuscenes_5sweeps_infos_val_radar.pkl'))
