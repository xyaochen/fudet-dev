...
class CoDet(MVXTwoStageDetector):
    def __init__(self,
                 ...
                 aux_weight=1.0, 
                 init_cfg=None):
        super(CoDet, self).__init__(init_cfg=init_cfg)
    ...
    def forward_pts_train(self,
        ...
        """
        outputs_classes, outputs_coords, aux_outs = self.pts_bbox_head(pts_feats, img_metas)
    ...
    def simple_test_pts(self, x, img_metas, rescale=False):
        ...
        outputs_classes, outputs_coords, aux_outs = self.pts_bbox_head(x, img_metas)
