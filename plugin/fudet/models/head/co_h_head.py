...
class CoHFUTRHead(DETRHead):
    ...
    def __init__(self,
        ...
        super(CoHFUTRHead, self).__init__(
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        assert self.num_query == self.num_queries_one2many+self.num_queries_one2one
        ...
        return outputs_classes_one2one, outputs_coords_one2one, \
                outputs_classes_one2many, outputs_coords_one2many, aux_outs
