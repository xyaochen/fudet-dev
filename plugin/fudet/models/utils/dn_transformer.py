...
class DNFutrTransformerDecoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, use_dab=False, anchor_size=2, no_sine_embed=False, look_forward_twice=False, return_intermediate=False, **kwargs):

        super(DNFutrTransformerDecoder, self).__init__(*args, **kwargs)
    ...
    def forward(self,
        ...
        for lid, layer in enumerate(self.layers):
            ...
            output = layer(
                ...
                *args,
                query_pos=query_pos,
                reference_points=reference_points_input[..., :2],
...
class DNFutrTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(DNFutrTransformer, self).__init__(init_cfg=init_cfg)
