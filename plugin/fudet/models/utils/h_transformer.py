...
class HFutrTransformerDecoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, use_dab=False, anchor_size=2, no_sine_embed=False, \
            look_forward_twice=False, return_intermediate=False, use_checkpoint=False, **kwargs):

        super(HFutrTransformerDecoder, self).__init__(*args, **kwargs)
...
class HFutrTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(HFutrTransformer, self).__init__(init_cfg=init_cfg)
