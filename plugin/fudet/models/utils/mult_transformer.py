...
class MultFutrTransformerDecoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, use_dab=False, anchor_size=2, no_sine_embed=False, return_intermediate=False, **kwargs):
        ...
        super(MultFutrTransformerDecoder, self).__init__(*args, **kwargs)
...
class MultFutrTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(MultFutrTransformer, self).__init__(init_cfg=init_cfg)
